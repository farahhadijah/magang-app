...
class Pkl extends Model
{
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | BUSINESS LOGIC (NEW ARCHITECTURE)
    |--------------------------------------------------------------------------
    */
    ...
    /**
     * Apakah semua logbook sudah approved
     */
    ...
    /**
     * Apakah memenuhi syarat upload laporan akhir
     */
    ...
    /**
     * Finalisasi PKL (dipanggil saat laporan approved)
     */
