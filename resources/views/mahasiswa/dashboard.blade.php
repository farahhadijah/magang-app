    ...
    <div class="py-6">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                            ...
                            <div class="p-3 bg-white rounded-lg bg-opacity-10">
                                ...
                                <p class="text-sm font-semibold text-white">
                                    @if(!$pengajuan)
                                        Belum Mulai
                                    @else
                                        {{ $pengajuan->status == 'disetujui' ? 'Aktif' : 'Dalam Proses' }}
                                    @endif
                                </p>
                            </div>
                            <div class="p-3 bg-white rounded-lg bg-opacity-10">
            ...
            @if ($pengajuan)
                ...
                <div class="p-6 mb-8 bg-white border border-green-100 shadow-sm rounded-xl">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute left-0 right-0 h-2 bg-green-100 rounded-full top-4"></div>
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3">
                {{-- STATUS PKL --}}
                <div class="relative overflow-hidden transition-all duration-300 bg-white border border-green-100 shadow-sm group rounded-xl hover:shadow-md">
                    <div class="absolute top-0 right-0 w-32 h-32 rounded-bl-full opacity-50 bg-gradient-to-bl from-green-100 to-transparent"></div>
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div class="overflow-hidden bg-white border border-green-100 shadow-sm rounded-xl">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="{{ route('mahasiswa.logbook.index') }}" class="text-sm font-medium text-green-600 hover:text-green-700">
                                Lihat Semua →
                            </a>
                        </div>
                            ...
                            <div class="relative w-32 h-32">
                                <svg class="w-32 h-32 transform -rotate-90">
                                    ...
                                    <circle
                                        ...
                                        stroke-dashoffset="{{ 351.86 - (351.86 * ($logbookTotal ?? 0) / ($hariPkl ?? 1)) }}"
                                        stroke-linecap="round"
                                    />
                                </svg>
                                <div class="absolute inset-0 flex flex-col items-center justify-center">
                                    <span class="text-2xl font-bold text-gray-800">{{ $logbookTotal ?? 0 }}</span>
                        ...
                        <div class="grid grid-cols-3 gap-4 mt-4 text-center">
                            <div class="p-3 rounded-lg bg-green-50">
                                ...
                                <p class="text-xl font-bold text-gray-800">{{ $hariPkl }}</p>
                            </div>
                            <div class="p-3 rounded-lg bg-green-50">
                                <p class="text-xs text-gray-500">Terisi</p>
                                <p class="text-xl font-bold text-green-600">{{ $logbookTotal }}</p>
                            </div>
                            <div class="p-3 {{ $logbookKosong > 0 ? 'bg-red-50' : 'bg-green-50' }} rounded-lg">
                ...
                <div class="overflow-hidden bg-white border border-green-100 shadow-sm rounded-xl">
                    <div class="p-6">
                        ...
                        <div class="p-4 {{ $isOverdue ? 'bg-red-50' : 'bg-green-50' }} rounded-lg">
