            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="username" class="block w-full p-2 pl-10 mt-1 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400" type="text" name="username" :value="old('username')" required autofocus autocomplete="off" />
                    </div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="password" class="block w-full p-2 pl-10 mt-1 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400" type="password" name="password" required autocomplete="current-password" />
                    </div>
                    <x-input-error :messages="$errors->get('password')" class="text-sm text-red-600"/>
                </div>
                <div class="flex items-center">
                    <input id="remember" type="checkbox" class="text-green-600 border-green-300 rounded shadow-sm focus:ring-green-500" name="remember" >
